...
public interface MemberDao {
	int MAX_LENGTH = 3; // 배열의 최대 길이. [public static final]
	 ...
	 */
	int create(Member member); // [public abstract] 추상메서드
	...
	/**
	 * 인덱스를 사용한 회원 정보 검색. 회원 배열의 특정 인덱스에 있는 회원정보를 리턴.
	 * @param index 검색할 인덱스. 0 이상의 정수 int
	 ...
	 * @param index 회원 배열에서 수정할 회원 정보의 위치(인덱스) int
	 * @param password 변경할 새 비밀번호. String
