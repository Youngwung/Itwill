...
public class WrapperEx {
	 ...
	 * 기본 타입: boolean, bute, short, int, long, char, float, double 
	 * wrapper: Boolean, Byte, Short, Integer,Long, Char, Float, Double
	...
	public static void main(String[] args) {
		// Integer 타입의 객체를 생성: int 값을 전달받아서 Integer 객체 생성.
