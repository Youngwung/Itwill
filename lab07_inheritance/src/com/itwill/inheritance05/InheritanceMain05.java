 ...
 * (ex) toString, equlas(), hashCode(), getClass() ... 
 ...
 *   o. 해시코드가 만족해야 하는 조건
 *   	1. 같은 객체에서 heshCode() 여러번 호출 하더라도 항상 같은 정수가 리턴되어야 함. =>난수 생성에서 사용 불가. 결과 예측이 가능한 객체에 사용 가능.
 *   	2. equals() 메서드의 결과가 ture가 되는 두 객체의 해시코드 값은 같아야 함.
...
public class InheritanceMain05 {
	...
	public static void main(String[] args) {
		...
		// 두 객체가 같으면 true를 리턴, 다르면 false를 리턴하는 메서드.
		...
		System.out.println(sc); //-> Scanner 클래스는 toString() 메서드를 override함.=> 출력 결과가 다른 클래스와 다름
