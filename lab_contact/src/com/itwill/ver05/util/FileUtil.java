...
public class FileUtil {
	...
	public static List<Contact> readDataFromFile() {
		...
		// 객체 생성 시 DATA_FILE가 실제로 존재하는 파일이 아니라면 에러가 뜰수 있음. 보완 필요.
		// 이 메서드를 호출할 때 파일이 있는 지 확인하는 조건문이 필요.
		try(
	...
	public static List<Contact> initializeData() { //파일이 없는 지 검사를 하고 읽기 위한 메서드
