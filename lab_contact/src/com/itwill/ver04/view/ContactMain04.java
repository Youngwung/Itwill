...
import com.itwill.ver04.view.ContactMain04;
...
public class ContactMain04 {
	...
	public static void main(String[] args) {
		...
		ContactMain04 app = new ContactMain04();	// 메서드를 사용하기 위한 메인 클래스 선언.
		boolean run = true;
	...
	private void updateContact() {
		...
		try { // NumberFormetException 해결을 위한 try-catch문
			...
			if (daoImpl.isvalidIndex(index)) {
				...
				Contact contact = new Contact(0, name, phone, email); // 수정할 정보를 아규먼트로 제공하기 위한 객체 생성
