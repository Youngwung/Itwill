 ...
 * 3. 리스트 중간에 있는 값을 삭제하면 인덱스가 자동으로 재배열됨. [1 2 3 4]배열에서 3을 리무브 시 [1 2 4] 가 됨.
 * 4. 같은 값들을 여러번 저장할 수 있음 - Set<E>과 다른 점.
 * 5. List<E>에서 <E>는 리스트에 저장하는 원소(element)의 타입을 의미.
 * 		(주의) 원소 타입은 클래스 이름만 사용 가능. 기본타입을 사용할 수 없음. (Integer 등으로 사용해야함.)    
 ...
 * 
 * LinkedList<E>의 특징:
 * 1. linked list 알고르즘을 이용한 리스트 - 이전/이후 노드의 주소를 저장하는 알고리즘.
 * 2. 값을 저장, 삭제 속도가 빠름.
 * 3. 검색 속도가 느림.
 */
...
//		ArrayList<int> numbers = new ArrayList();
		...
		System.out.println(numbers);// 출력문: [1, 100, -100] => toString()을 오버로딩.
		// ArrayList의 원소 삭제
