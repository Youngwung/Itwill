...
// (2) import 문장 없이 패키지 이름을 포함한 전체클래스 이름으로 변수를 선언.
...
//		com.itwill.modifier01.AccessExample ex = new com.itwill.modifier01.AccessExample(1, 2, 3, 4);
		// =>import문 없이 다른 패키지의 클래스를 가져오고싶으면 써야하는 코드.
