...
/*
 * 객체지향 프로그래밍 언어(Object-Oriented Programming Language): Java, C++, C#, Kolin, ...
...
public class ClassMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s1length: "+s1.length()); // length():문자열 객체의 기능(메서드)
		System.out.println("s1concat: " + s1.concat("비가 오네요..."));
		
		String s2 = new String("Hello");
		System.out.println("s2length: "+ s2.length());
