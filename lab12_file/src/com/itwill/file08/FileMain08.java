 ...
 * 		- (Windows 예) C:\study\git\Itwill\lab12_file\data\hello.txt
 ...
 * 		- windows: \
 * 		- Linux, MacOs: /
 * 		- 문자열("") 안에서 백슬래쉬(\)는 특별한 의미(escape 문자)
 * 		  o. "\n": 줄바꿈, "\t": 탭, "\s": 공백, "\\": 백슬래쉬
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		...
		String path = "C:\\study\\git\\Itwill\\lab12_file"; // Windows 절대 경로 표현법.
		
//		String path2 = "data\\hello.txt"; // Windows 상대 경로 표현법
		//Windows만 사용 가능한 경로 표현법
		
		String path2 = "data"+File.separator + "hello.txt"; // OS에 무관한 상대 경로
		// OS에 따라서 달라지는 구분자를 넣어줌.
...
//		System.out.println(testFolder.getAbsolutePath()); // 만들 폴더 위치 확인
